...
public class NewsServiceImp implements NewsService {
	...
	@Override
	public List<News> findNewsListByPage(News news,Integer page,Integer n) throws Exception {
		// TODO Auto-generated method stub
		return newsMapper.findNewsListByPage(news, page,n);
	}

	@Override
	public byte[] getNewsPic(Integer id) throws Exception {
		// TODO Auto-generated method stub
		News news = newsMapper.getNewsPic(id);
		return news.getPic();
	}
	...
	public List<News> findSortNewsList(News news) throws Exception {
		// TODO Auto-generated method stub
		return newsMapper.findSortNewsList(news);
	}
