...
public interface NewsMapper {
	...
	List<News> findNewsListByPage(@Param("news")News news,@Param("page")Integer page,@Param("n")Integer n);
	...
	List<News> findSortNewsList(News news); //找到具体的分类新闻

	News getNewsPic(Integer id);
}