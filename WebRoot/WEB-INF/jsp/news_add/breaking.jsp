		...
		<div class="container">
			...
			<div class="breaking-news-grids">
				<div class="col-md-8 breaking-news-grid-left">
					...
					<script src="${pageContext.request.contextPath}/res/js/jquery.wmuSlider.js"></script> 
					  <script>
						$('.example1').wmuSlider();         
					 </script> 
				...
				<div class="col-md-4 breaking-news-grid-right">
					...
					<ul>
						...
						<li>
							<div class="breaking-news-grid-right-grids">
								<div class="breaking-news-grid-right-gridl">
									<a href="#"><img src="${pageContext.request.contextPath}/res/images/12.jpg" alt=" " class="img-responsive" /></a>
								</div>
								<div class="breaking-news-grid-right-gridr">
									<h4><a href="single.html">ut labore et dolore magnam aliquam quaerat voluptatem</a></h4>
									<ul>
						...
						<li>
							<div class="breaking-news-grid-right-grids">
								<div class="breaking-news-grid-right-gridl">
									<a href="#"><img src="${pageContext.request.contextPath}/res/images/13.jpg" alt=" " class="img-responsive" /></a>
								</div>
								<div class="breaking-news-grid-right-gridr">
									<h4><a href="single.html">ut labore et dolore magnam aliquam quaerat voluptatem</a></h4>
									<ul>
			...
			<div class="video-grids">
					<div class="col-md-8 video-grids-left">
						<div class="video-grids-left1">
							<img src="${pageContext.request.contextPath}/res/images/9.jpg" alt=" " class="img-responsive">
							...
							<div class="video-grid-pos">
								...
								<!-- pop-up-box -->
								<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/modernizr.custom.min.js"></script>    
								<link href="${pageContext.request.contextPath}/res/css/popuo-box.css" rel="stylesheet" type="text/css" media="all">
								<script src="${pageContext.request.contextPath}/res/js/jquery.magnific-popup.js" type="text/javascript"></script>
								<!--//pop-up-box -->
						...
						<div class="video-grids-left2">
							<div class="course_demo1">
								...
								<li class="nbs-flexisel-item" style="width: 243px;">
										<div class="item">
											<img src="${pageContext.request.contextPath}/res/images/10.jpg" alt=" " class="img-responsive">
											<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
													<i> </i>
											</a>
											<div id="small-dialog" class="mfp-hide">
										...
										<div class="item">
											<img src="${pageContext.request.contextPath}/res/images/11.jpg" alt=" " class="img-responsive">
											<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
													<i> </i>
											</a>
											<div id="small-dialog" class="mfp-hide">
							 ...
							 <script type="text/javascript" src="${pageContext.request.contextPath}/res/js/jquery.flexisel.js"></script>
						</div>
					</div>
					<div class="col-md-4 video-grids-right">
						<div class="sap_tabs">	
							<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
								...
								<script src="${pageContext.request.contextPath}/res/js/easyResponsiveTabs.js" type="text/javascript"></script>
								<script type="text/javascript">
									$(document).ready(function () {
