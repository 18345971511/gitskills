				...
				<div class="col-md-8 upcoming-events-left">
					...
					<div class="gallery">
						<div class="col-md-5 gallery-left">
							<div class="grid">
								<figure class="effect-lexi">
									<img src="${pageContext.request.contextPath}/res/images/21.jpg" alt="" class="img-responsive" />
									<figcaption>
						...
						<div class="col-md-7 gallery-right">
							...
							<div class="gallery-right1">
								<div class="gallery-right1-left">
									<img src="${pageContext.request.contextPath}/res/images/16.jpg" alt=" " class="img-responsive" />
								</div>
								<div class="gallery-right1-right">
					...
					<div class="upcoming-events-left-grids">
						<div class="col-md-6 upcoming-events-left1">
							<div class="upcoming-events-left11">
								<img src="${pageContext.request.contextPath}/res/images/19.jpg" alt=" " class="img-responsive" />
						...
						<div class="col-md-6 upcoming-events-left2">
							<div class="upcoming-events-left11">
								<img src="${pageContext.request.contextPath}/res/images/20.jpg" alt=" " class="img-responsive" />
								<a class="play-icon popup-with-zoom-anim" href="#small-dialog">
										<i> </i>
								</a>
								<div class="news-eve">
					...
					<div class="news-grids">
						<div class="col-md-8 news-grid-left">
							...
							<ul>
								...
								<li>
									<div class="news-grid-left1">
										<img src="${pageContext.request.contextPath}/res/images/17.jpg" alt=" " class="img-responsive" />
									</div>
									<div class="news-grid-right1">
