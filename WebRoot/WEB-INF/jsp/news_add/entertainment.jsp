...
<html>
<head>
<title>News Times a Entertainment Category Flat Bootstrap Responsive Website Template | Entertainment:: w3layouts</title>
...
<!-- Custom Theme files -->
<link href="${pageContext.request.contextPath}/res/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="${pageContext.request.contextPath}/res/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script src="${pageContext.request.contextPath}/res/js/jquery-1.11.1.min.js"></script>
<!-- //js -->
<!-- pop-up-script -->
<script src="${pageContext.request.contextPath}/res/js/jquery.chocolat.js"></script>
...
<!-- //pop-up-script -->
<!-- sb-slider -->
<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/modernizr.custom.46884.js"></script>
	...
	<div class="slicebox-slider">
		<div class="container">
			<div class="move-text">
				...
				<div class="clearfix"></div>
				<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/jquery.marquee.js"></script>
				<script>
				...
				<div class="col-md-8 slicebox-slider-left">
					<div class="wrapper1">
							...
							<ul id="sb-slider" class="sb-slider">
								<li>
									<a href="#" target="_blank"><img src="${pageContext.request.contextPath}/res/images/24.jpg" alt="" class="img-responsive" /></a>
									<div class="sb-description">
										<h3>wonderful music</h3>
									</div>
								</li>
								<li>
									<a href="#" target="_blank"><img src="${pageContext.request.contextPath}/res/images/25.jpg" alt="" class="img-responsive" /></a>
									<div class="sb-description">
										<h3>Honest Entertainer</h3>
									</div>
								</li>
								<li>
									<a href="#" target="_blank"><img src="${pageContext.request.contextPath}/res/images/26.jpg" alt="" class="img-responsive" /></a>
									<div class="sb-description">
					...
					<script type="text/javascript" src="${pageContext.request.contextPath}/res/js/jquery.slicebox.js"></script>
					<script type="text/javascript">
						$(function() {
						...
						<div class="gallery-grids">
							<div class="col-md-4 gallery-grid">
								<div class="gallery-grd">
									<a href="${pageContext.request.contextPath}/res/images/18.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="${pageContext.request.contextPath}/res/images/18.jpg" alt=" " class="img-responsive" />
									</a>
								</div>
								<div class="gallery-grd grd">
									<a href="${pageContext.request.contextPath}/res/images/15.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="${pageContext.request.contextPath}/res/images/15.jpg" alt=" " class="img-responsive" />
									</a>
								</div>
							</div>
							<div class="col-md-4 gallery-grid">
								<div class="gallery-grd">
									<a href="${pageContext.request.contextPath}/res/images/12.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="${pageContext.request.contextPath}/res/images/12.jpg" alt=" " class="img-responsive" />
									</a>
								</div>
								<div class="gallery-grd grd">
									<a href="${pageContext.request.contextPath}/res/images/13.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="${pageContext.request.contextPath}/res/images/13.jpg" alt=" " class="img-responsive" />
									</a>
								</div>
							</div>
							<div class="col-md-4 gallery-grid">
								<div class="gallery-grd">
									<a href="${pageContext.request.contextPath}/res/images/21.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
										<img src="${pageContext.request.contextPath}/res/images/21.jpg" alt=" " class="img-responsive mobile1" />
									</a>
								</div>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							<div class="breaking-news-grid-right-grids">
								<div class="breaking-news-grid-right-gridl">
									<a href="#"><img src="${pageContext.request.contextPath}/res/images/11.jpg" alt=" " class="img-responsive"></a>
								</div>
