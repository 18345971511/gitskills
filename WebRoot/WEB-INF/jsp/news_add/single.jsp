				...
				<div class="col-md-8 blog-left">
					<div class="blog-left-grid">
						...
						<div class="blog-leftr">
							<img src="${pageContext.request.contextPath}/res/images/25.jpg" alt=" " class="img-responsive" />
						...
						<div class="admin-text">
								...
								<div class="admin-text-left">
									<a href="#"><img src="${pageContext.request.contextPath}/res/images/icon1.png" alt=""/></a>
								</div>
						...
						<div class="response">
							...
							<div class="media response-info">
								<div class="media-left response-text-left">
									<a href="#">
										<img class="media-object" src="${pageContext.request.contextPath}/res/images/icon1.png" alt=""/>
									</a>
					...
					<div class="recent">
						...
						<div class="recent-grids">
							<div class="recent-grid">
								<div class="wom">
									<a href="#"><img src="${pageContext.request.contextPath}/res/images/6.jpg" alt=" " class="img-responsive" /></a>
								</div>
								<div class="wom-right">
							...
							<div class="recent-grid">
								<div class="wom">
									<a href="#"><img src="${pageContext.request.contextPath}/res/images/7.jpg" alt=" " class="img-responsive" /></a>
								</div>
								<div class="wom-right">
									<h4><a href="#">Integer rutrum ante eu</a></h4>
									<p>Mauris fermentum dictum magna. Sed laoreet aliquam leo. 
							...
							<div class="recent-grid">
								<div class="wom">
									<a href="#"><img src="${pageContext.request.contextPath}/res/images/8.jpg" alt=" " class="img-responsive" /></a>
								</div>
								<div class="wom-right">
									<h4><a href="#">Integer rutrum ante eu</a></h4>
									<p>Mauris fermentum dictum magna. Sed laoreet aliquam leo. 
